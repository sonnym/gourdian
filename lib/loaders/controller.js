 ...
 * @api public
 */
ControllerLoader.prototype.run = function(route, client_session, request_body, response, params) {
  var action = this.get(route, client_session, request_body, null, null, null, params);
 ...
 * @api public
 */
ControllerLoader.prototype.get = function(route, client_session, request_body, socket, message, sockets, params) {
