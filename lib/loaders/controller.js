 ...
 * @api public
 */
module.exports = ControllerLoader = function(base_path) {
  this._template_loader = new TemplateLoader(base_path);
  this._controllers = {};

  var controllers_path = path.join(base_path, "app", "controllers")
 ...
 * @api public
 */
ControllerLoader.prototype.run = function(route, client_session, request_body, response) {
  var action = this.get(route, client_session, request_body);
 ...
 * @api public
 */
ControllerLoader.prototype.get = function(route, client_session, request_body, socket, message, sockets) {
