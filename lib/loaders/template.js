 ...
 * @api public
 */
var TemplateLoader = module.exports = function() {
...
TemplateLoader.prototype.load = function(p, ext, context, callback) {
  ...
  if (this._template_cache[template_name]) {
    Gourdian.Logger.info("Retrieved template for " + template_name + " from the cache");
  ...
  // fs lookup
    ...
    Gourdian.Configuration.operate_on_paths(["app", "views", path_parts, filename + "." + ext + ".html"], function(error, template_location) {
