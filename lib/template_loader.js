 ...
 * @api public
 */
module.exports = TemplateLoader = function(base_path) {
 ...
 *
 * @param {String} path internal path of template
 * @param {String} ext templae extansion
...
TemplateLoader.prototype.resolve_template = function(template_path, extension) {
 return path.join(this._base_path, "app", "views", template_path) + "." + extension + ".html";
};
