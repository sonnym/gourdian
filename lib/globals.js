...
class_loader.load(path.join(__dirname, "loaders"), null, { pollute: true, prefix: 1});
...
class_loader.load(path.join(__dirname, "handlers"), null, { pollute: true, prefix: 1});

// user space classes
global.Model = require(path.join(__dirname, "model"));
