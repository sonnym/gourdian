...
TestRunner.prototype.__defineSetter__("timeout", function(v) { this._timeout = parseInt(v) });
...
TestRunner.prototype.observe = function(test_file, test_name) {
  ...
  } else if (test_instance.start_date && (new Date() - test_instance.start_date) > this._timeout) {
    this._counts.e++;
    process.stdout.write("\x1B[1;37me\x1B[0m")
