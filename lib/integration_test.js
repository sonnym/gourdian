...
function ensure_server_is_bound(server, callback) {
  //console.log(server);
  if (server.bound_to_port) callback(server);
  else setTimeout(function () { ensure_server_is_bound.call(this, server, callback) }, null);
}
