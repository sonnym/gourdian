...
Router.prototype.__defineGetter__("need_http_server", function() {
  return this._routes && this._routes.http && this._routes.http.length > 0;
});
Router.prototype.__defineGetter__("need_socket_server", function() {
  return this._routes && this._routes.socket && _.keys(this._routes.socket).length > 0;
});
...
Router.prototype.__defineGetter__("sockets", function() {
  return this._routes ? this._routes.socket : {};
});
