...
Gourdian.ClassLoader.load(path.join(__dirname, "loaders"), null, { pollute: false, attach: Gourdian, prefix: 1 });

exports.IHandler = require("./ihandler");
Gourdian.ClassLoader.load(path.join(__dirname, "handlers"), null, { pollute: false, attach: Gourdian, prefix: 1 });

// user space classes
exports.Model = require("./model");
exports.Controller = require("./controller");

Gourdian.ClassLoader.load(path.join(process.cwd(), "app", "models"), null, { pollute: true });
